...
var u = $("#sf1Name").val();
var r = $("#sf1Email").val(); 
var t = $("#sf1PhoneNum").val(); 
/*var s = $("#text3").val(); */
    $.ajax({  
      type: "POST",  
      url: "d.php",  
      data: {  u: u, r: r, t: t, /*s: s,*/ a:'otprpismo', n:'Форма заказа с сайта' },  
      success: function() {
		 $('#signup-form-1')[0].reset();  
         //alert("Спасибо. Ваше сообщение отправлено."); 
		 $('#signup-form-1').html('<h3>Спасибо, Ваше сообщение отправлено,<br>в скором времени мы свяжемся с Вами.</h3>');  
      },  
      dataType: 'html'  
    });  
};
